...
const $Body_chat_api_v1_pipelines__pipeline_id__chat_post = {
    properties: {
...
const $ExtractionResultCreateBatch = {
    properties: {
        schema_id: {
            type: "string",
            format: "uuid",
...
exports.$APIKeyCreate = $APIKeyCreate;
exports.$APIKeyUpdate = $APIKeyUpdate;
exports.$AzureOpenAIEmbedding = $AzureOpenAIEmbedding;
exports.$Base = $Base;
exports.$BasePromptTemplate = $BasePromptTemplate;
exports.$BedrockEmbedding = $BedrockEmbedding;
exports.$Body_chat_api_v1_pipelines__pipeline_id__chat_post = $Body_chat_api_v1_pipelines__pipeline_id__chat_post;
exports.$Body_import_pipeline_metadata_api_v1_pipelines__pipeline_id__metadata_put = $Body_import_pipeline_metadata_api_v1_pipelines__pipeline_id__metadata_put;
exports.$Body_upload_file_api_parsing_upload_post = $Body_upload_file_api_parsing_upload_post;
exports.$Body_upload_file_api_v1_files_post = $Body_upload_file_api_v1_files_post;
exports.$Body_upload_file_api_v1_parsing_upload_post = $Body_upload_file_api_v1_parsing_upload_post;
exports.$ChatMessage = $ChatMessage;
exports.$ChatParams = $ChatParams;
exports.$CheckoutSessionCreatePayload = $CheckoutSessionCreatePayload;
exports.$CloudAzStorageBlobDataSource = $CloudAzStorageBlobDataSource;
exports.$CloudAzureAISearchVectorStore = $CloudAzureAISearchVectorStore;
exports.$CloudChromaVectorStore = $CloudChromaVectorStore;
exports.$CloudDocument = $CloudDocument;
exports.$CloudDocumentCreate = $CloudDocumentCreate;
exports.$CloudJiraDataSource = $CloudJiraDataSource;
exports.$CloudNotionPageDataSource = $CloudNotionPageDataSource;
exports.$CloudOneDriveDataSource = $CloudOneDriveDataSource;
exports.$CloudPineconeVectorStore = $CloudPineconeVectorStore;
exports.$CloudPostgresVectorStore = $CloudPostgresVectorStore;
exports.$CloudQdrantVectorStore = $CloudQdrantVectorStore;
exports.$CloudS3DataSource = $CloudS3DataSource;
exports.$CloudSharepointDataSource = $CloudSharepointDataSource;
exports.$CloudSlackDataSource = $CloudSlackDataSource;
exports.$CloudWeaviateVectorStore = $CloudWeaviateVectorStore;
...
exports.$ConfigurableTransformationDefinition = $ConfigurableTransformationDefinition;
exports.$ConfigurableTransformationNames = $ConfigurableTransformationNames;
exports.$ConfiguredTransformationItem = $ConfiguredTransformationItem;
exports.$CustomerPortalSessionCreatePayload = $CustomerPortalSessionCreatePayload;
exports.$DataSink = $DataSink;
exports.$DataSinkCreate = $DataSinkCreate;
exports.$DataSinkDefinition = $DataSinkDefinition;
exports.$DataSinkUpdate = $DataSinkUpdate;
exports.$DataSource = $DataSource;
exports.$DataSourceCreate = $DataSourceCreate;
exports.$DataSourceDefinition = $DataSourceDefinition;
exports.$DataSourceUpdate = $DataSourceUpdate;
exports.$DefaultOrganizationUpdate = $DefaultOrganizationUpdate;
exports.$EvalDataset = $EvalDataset;
exports.$EvalDatasetCreate = $EvalDatasetCreate;
exports.$EvalDatasetJobParams = $EvalDatasetJobParams;
exports.$EvalDatasetJobRecord = $EvalDatasetJobRecord;
exports.$EvalDatasetUpdate = $EvalDatasetUpdate;
exports.$EvalExecutionCreate = $EvalExecutionCreate;
exports.$EvalExecutionParams = $EvalExecutionParams;
exports.$EvalExecutionParamsOverride = $EvalExecutionParamsOverride;
exports.$EvalLLMModelData = $EvalLLMModelData;
exports.$EvalQuestion = $EvalQuestion;
exports.$EvalQuestionCreate = $EvalQuestionCreate;
exports.$EvalQuestionResult = $EvalQuestionResult;
exports.$ExtractionResult = $ExtractionResult;
exports.$ExtractionResultCreate = $ExtractionResultCreate;
exports.$ExtractionResultCreateBatch = $ExtractionResultCreateBatch;
exports.$ExtractionSchema = $ExtractionSchema;
exports.$ExtractionSchemaCreate = $ExtractionSchemaCreate;
exports.$ExtractionSchemaUpdate = $ExtractionSchemaUpdate;
exports.$File = $File;
...
exports.$HuggingFaceInferenceAPIEmbedding = $HuggingFaceInferenceAPIEmbedding;
exports.$JSONNodeParser = $JSONNodeParser;
exports.$LLM = $LLM;
exports.$LlamaParseParameters = $LlamaParseParameters;
exports.$LlamaParseSupportedFileExtensions = $LlamaParseSupportedFileExtensions;
exports.$LocalEval = $LocalEval;
exports.$LocalEvalResults = $LocalEvalResults;
exports.$LocalEvalSetCreate = $LocalEvalSetCreate;
exports.$LocalEvalSets = $LocalEvalSets;
exports.$ManagedIngestionStatus = $ManagedIngestionStatus;
exports.$ManagedIngestionStatusResponse = $ManagedIngestionStatusResponse;
exports.$MarkdownElementNodeParser = $MarkdownElementNodeParser;
exports.$MarkdownNodeParser = $MarkdownNodeParser;
exports.$MessageRole = $MessageRole;
exports.$MetadataFilter = $MetadataFilter;
exports.$MetadataFilters = $MetadataFilters;
...
exports.$ParsingHistoryItem = $ParsingHistoryItem;
exports.$ParsingJob = $ParsingJob;
exports.$ParsingJobJsonResult = $ParsingJobJsonResult;
exports.$ParsingJobMarkdownResult = $ParsingJobMarkdownResult;
exports.$ParsingJobTextResult = $ParsingJobTextResult;
exports.$ParsingUsage = $ParsingUsage;
exports.$Pipeline = $Pipeline;
exports.$PipelineCreate = $PipelineCreate;
exports.$PipelineDataSource = $PipelineDataSource;
exports.$PipelineDataSourceCreate = $PipelineDataSourceCreate;
exports.$PipelineDeployment = $PipelineDeployment;
exports.$PipelineFile = $PipelineFile;
exports.$PipelineFileCreate = $PipelineFileCreate;
exports.$PipelineFileUpdate = $PipelineFileUpdate;
exports.$PipelineType = $PipelineType;
exports.$PipelineUpdate = $PipelineUpdate;
exports.$Pooling = $Pooling;
exports.$PresetRetrievalParams = $PresetRetrievalParams;
exports.$PresignedUrl = $PresignedUrl;
exports.$Project = $Project;
exports.$ProjectCreate = $ProjectCreate;
exports.$ProjectUpdate = $ProjectUpdate;
exports.$PromptMixinPrompts = $PromptMixinPrompts;
exports.$PromptSpec = $PromptSpec;
exports.$PydanticProgramMode = $PydanticProgramMode;
exports.$RelatedNodeInfo = $RelatedNodeInfo;
exports.$RetrievalMode = $RetrievalMode;
exports.$RetrievalParams = $RetrievalParams;
exports.$RetrieveResults = $RetrieveResults;
exports.$SentenceSplitter = $SentenceSplitter;
exports.$SimpleFileNodeParser = $SimpleFileNodeParser;
exports.$StatusEnum = $StatusEnum;
exports.$SupportedEvalLLMModel = $SupportedEvalLLMModel;
exports.$SupportedEvalLLMModelNames = $SupportedEvalLLMModelNames;
exports.$TextNode = $TextNode;
exports.$TextNodeWithScore = $TextNodeWithScore;
...
exports.$UserOrganizationCreate = $UserOrganizationCreate;
