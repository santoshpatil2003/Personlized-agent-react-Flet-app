...
declare const $Body_chat_api_v1_pipelines__pipeline_id__chat_post: {
    readonly properties: {
        readonly retrieval_parameters: {
            readonly $ref: "#/components/schemas/PresetRetrievalParams";
        };
        readonly data: {
            readonly $ref: "#/components/schemas/ChatParams";
        };
    };
    readonly type: "object";
    readonly required: readonly ["retrieval_parameters", "data"];
    readonly title: "Body_chat_api_v1_pipelines__pipeline_id__chat_post";
};
...
declare const $ConfigurableDataSourceNames: {
    readonly type: "string";
    readonly enum: readonly ["S3", "AZURE_STORAGE_BLOB", "MICROSOFT_ONEDRIVE", "MICROSOFT_SHAREPOINT", "SLACK", "NOTION_PAGE", "JIRA"];
...
declare const $ExtractionResultCreate: {
    readonly properties: {
        readonly schema_id: {
            readonly type: "string";
            readonly format: "uuid";
    ...
    readonly title: "ExtractionResultCreate";
    readonly description: "Schema for creating an extraction result.";
};
declare const $ExtractionResultCreateBatch: {
    readonly properties: {
        readonly schema_id: {
            readonly type: "string";
            readonly format: "uuid";
    ...
    readonly title: "ExtractionResultCreateBatch";
    readonly description: "Schema for creating extraction results in batch.";
};
declare const $ExtractionSchema: {
    ...
    readonly type: "object";
    readonly required: readonly ["id", "name", "project_id", "data_schema"];
...
declare const $Pipeline: {
    readonly properties: {
        ...
        readonly llama_parse_enabled: {
            readonly type: "boolean";
            readonly title: "Llama Parse Enabled";
            readonly description: "Whether to use LlamaParse during pipeline execution.";
            readonly default: true;
        };
...
declare const $UserOrganization: {
    ...
    readonly type: "object";
    readonly required: readonly ["id", "email", "user_id", "organization_id"];
...
type Body_chat_api_v1_pipelines__pipeline_id__chat_post = {
...
type CloudAzureAISearchVectorStore = {
    ...
    index_name?: string;
    filterable_metadata_field_keys?: Array<string>;
 ...
 * An enumeration.
 */
type ConfigurableDataSourceNames = "S3" | "AZURE_STORAGE_BLOB" | "MICROSOFT_ONEDRIVE" | "MICROSOFT_SHAREPOINT" | "SLACK" | "NOTION_PAGE" | "JIRA";
/**
 * An enumeration.
 */
declare const ConfigurableDataSourceNames: {
...
type DataSource = {
    ...
    component: {
        [key: string]: unknown;
    } | CloudS3DataSource | CloudAzStorageBlobDataSource | CloudOneDriveDataSource | CloudSharepointDataSource | CloudSlackDataSource | CloudNotionPageDataSource | CloudJiraDataSource;
    project_id: string;
};
/**
...
/**
 * Schema for creating extraction results in batch.
 */
type ExtractionResultCreateBatch = {
    /**
     * The id of the schema
     */
    schema_id: string;
...
type ChatApiV1PipelinesPipelineIdChatPostData = {
    pipelineId: string;
    requestBody: Body_chat_api_v1_pipelines__pipeline_id__chat_post;
    session?: string;
};
...
type ListJobsApiV1ExtractionJobsGetResponse = Array<ExtractionResult>;
type RunJobApiV1ExtractionJobsPostData = {
    requestBody: ExtractionResultCreate;
    session?: string;
};
type RunJobApiV1ExtractionJobsPostResponse = ExtractionResult;
type GetJobApiV1ExtractionJobsJobIdGetData = {
    jobId: string;
    session?: string;
};
type GetJobApiV1ExtractionJobsJobIdGetResponse = ExtractionResult;
type RunJobsInBatchApiV1ExtractionJobsBatchPostData = {
    requestBody: ExtractionResultCreateBatch;
    session?: string;
};
type RunJobsInBatchApiV1ExtractionJobsBatchPostResponse = Array<ExtractionResult>;
