...
var index_cjs = require('../decorator/index.cjs');
var zod = require('zod');
 ...
 */ class TextNode extends BaseNode {
   ...
   * @returns
   */ generateHash() {
        const hashFunction = env.createSHA256();
...
class ImageNode extends TextNode {
    ...
    getUrl() {
        ...
        const absPath = env.path.resolve(this.id_);
...
exports.ModalityType = void 0;
(function(ModalityType) {
    ModalityType["TEXT"] = "TEXT";
    ModalityType["IMAGE"] = "IMAGE";
})(exports.ModalityType || (exports.ModalityType = {}));
...
const anyFunctionSchema = zod.z.function(zod.z.tuple([]).rest(zod.z.any()), zod.z.any());
const toolMetadataSchema = zod.z.object({
    description: zod.z.string(),
    name: zod.z.string(),
    parameters: zod.z.record(zod.z.any())
});
const baseToolSchema = zod.z.object({
...
exports.anyFunctionSchema = anyFunctionSchema;
exports.baseToolSchema = baseToolSchema;
exports.baseToolWithCallSchema = baseToolWithCallSchema;
exports.jsonToNode = jsonToNode;
exports.splitNodesByType = splitNodesByType;
exports.toolMetadataSchema = toolMetadataSchema;
