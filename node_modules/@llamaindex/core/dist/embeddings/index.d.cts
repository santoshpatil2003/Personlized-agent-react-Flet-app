...
import { TransformComponent, BaseNode } from '../schema/index.cjs';
...
declare abstract class BaseEmbedding implements TransformComponent<BaseEmbeddingOptions> {
    ...
    transform(nodes: BaseNode[], options?: BaseEmbeddingOptions): Promise<BaseNode[]>;
