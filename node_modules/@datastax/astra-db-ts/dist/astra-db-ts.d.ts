 ...
 * @public
 */
export declare interface CollectionSpawnOptions extends WithNamespace {
    /**
 ...
 * @public
 */
export declare interface EmbeddingProviderParameterInfo {
    /**
...
/* Excluded from this release type: NamespaceRef */
 ...
 * @public
 */
export declare type NamespaceReplicationOptions = {
    class: 'SimpleStrategy';
    replicationFactor: number;
} | {
    class: 'NetworkTopologyStrategy';
