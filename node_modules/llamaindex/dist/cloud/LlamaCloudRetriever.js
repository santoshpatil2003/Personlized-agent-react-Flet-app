...
export class LlamaCloudRetriever {
    ...
    async retrieve({ query, preFilters }) {
        ...
        const pipeline = await PipelinesService.getPipelineApiV1PipelinesPipelineIdGet({
            pipelineId: pipelines[0].id
        });
        if (!pipeline) {
            throw new Error(`No pipeline found with name ${this.pipelineName} in project ${this.projectName}`);
        }
        const results = await PipelinesService.runSearchApiV1PipelinesPipelineIdRetrievePost({
