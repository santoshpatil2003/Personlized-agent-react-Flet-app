...
export function validateIsFlat(obj) {
...
export function nodeToMetadata(node, removeText = false, textField = DEFAULT_TEXT_KEY, flatMetadata = false) {
...
export function metadataDictToNode(metadata, options) {
...
export const parsePrimitiveValue = (value)=>{
