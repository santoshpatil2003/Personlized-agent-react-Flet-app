...
import { DEFAULT_CHUNK_OVERLAP_RATIO, DEFAULT_CONTEXT_WINDOW, DEFAULT_NUM_OUTPUTS, DEFAULT_PADDING } from "./constants.js";
export function getEmptyPromptTxt(prompt) {
    return prompt({});
}
/**
 ...
 * @param prompts
 * @returns
 */ export function getBiggestPrompt(prompts) {
