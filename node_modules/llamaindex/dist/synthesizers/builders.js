...
import { defaultRefinePrompt, defaultTextQaPrompt, defaultTreeSummarizePrompt } from "../Prompt.js";
import { getBiggestPrompt } from "../PromptHelper.js";
import { PromptMixin } from "../prompts/Mixin.js";
import { llmFromSettingsOrContext, promptHelperFromSettingsOrContext } from "../Settings.js";
var ResponseMode;
/**
 ...
 */ export class Refine extends PromptMixin {
    ...
    async giveResponseSingle(queryStr, textChunk, stream) {
        ...
        for(let i = 0; i < textChunks.length; i++){
            ...
            if (!response) {
                ...
                response = await this.refineResponseSingle(response, queryStr, chunk, stream && lastChunk);
            }
        }
        return response;
    }
    // eslint-disable-next-line max-params
    async refineResponseSingle(initialReponse, queryStr, textChunk, stream) {
...
export function getResponseBuilder(serviceContext, responseMode) {
    switch(responseMode){
        case "simple":
