...
export function getAzureConfigFromEnv(init) {
    const deployment = init?.deploymentName ?? init?.deployment ?? getEnv("AZURE_OPENAI_DEPLOYMENT") ?? // From Azure docs
...
export function getAzureBaseUrl(config) {
    return `${config.endpoint}/openai/deployments/${config.deploymentName}`;
}
export function getAzureModel(openAIModel) {
