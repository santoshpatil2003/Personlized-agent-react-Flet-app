...
import { extractText, streamCallbacks, streamConverter, wrapLLMEvent } from "@llamaindex/core/utils";
...
export var ReplicateChatStrategy;
...
If a question does not make any sense, or is not factually coherent, explain why instead of answering something not correct. If you don't know the answer to a question, please don't share false information.`;
    ...
    async chat(params) {
        ...
        if (stream) {
            ...
            return streamCallbacks(streamConverter(stream, (chunk)=>{
                if (chunk.event === "done") {
                    return null;
                }
                return {
