...
const _utils = require("../storage/docStore/utils.js");
const _SimpleKVStore = require("../storage/kvStore/SimpleKVStore.js");
...
class IngestionCache {
    ...
    constructor(collection){
        ...
        this.cache = new _SimpleKVStore.SimpleKVStore();
    }
    async put(hash, nodes) {
        const val = {
            [this.nodesKey]: nodes.map((node)=>(0, _utils.docToJson)(node))
        };
    ...
    async get(hash) {
        ...
        return json[this.nodesKey].map((doc)=>(0, _utils.jsonToDoc)(doc));
    }
}
