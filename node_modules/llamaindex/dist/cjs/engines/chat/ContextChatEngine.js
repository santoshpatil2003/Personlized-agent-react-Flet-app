...
class ContextChatEngine extends _Mixin.PromptMixin {
    ...
    constructor(init){
        super();
        _initProto(this);
        this.chatModel = init.chatModel ?? _Settings.Settings.llm;
    ...
    async chat(params) {
        ...
        if (stream) {
            ...
            }), (r)=>_EngineResponse.EngineResponse.fromChatResponseChunk(r, requestMessages.nodes));
        }
        const response = await this.chatModel.chat({
            messages: requestMessages.messages
        });
        chatHistory.addMessage(response.message);
        return _EngineResponse.EngineResponse.fromChatResponse(response, requestMessages.nodes);
    }
    reset() {
