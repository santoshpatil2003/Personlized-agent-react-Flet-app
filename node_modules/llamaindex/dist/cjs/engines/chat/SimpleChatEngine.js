...
class SimpleChatEngine {
    ...
    constructor(init){
        ...
        this.llm = init?.llm ?? _Settings.Settings.llm;
    }
    async chat(params) {
        ...
        if (stream) {
            ...
            }), _EngineResponse.EngineResponse.fromChatResponseChunk);
        }
        const response = await this.llm.chat({
            messages: await chatHistory.requestMessages()
        });
        chatHistory.addMessage(response.message);
        return _EngineResponse.EngineResponse.fromChatResponse(response);
    }
    reset() {
