...
const OPERATOR_TO_FILTER = {
    [_types.FilterOperator.EQ]: ({ key, value }, metadata)=>{
        return (0, _utils1.parsePrimitiveValue)(metadata[key]) === (0, _utils1.parsePrimitiveValue)(value);
    },
    [_types.FilterOperator.NE]: ({ key, value }, metadata)=>{
        return (0, _utils1.parsePrimitiveValue)(metadata[key]) !== (0, _utils1.parsePrimitiveValue)(value);
    },
    [_types.FilterOperator.IN]: ({ key, value }, metadata)=>{
        return (0, _utils1.parseArrayValue)(value).includes((0, _utils1.parsePrimitiveValue)(metadata[key]));
    },
    [_types.FilterOperator.NIN]: ({ key, value }, metadata)=>{
        return !(0, _utils1.parseArrayValue)(value).includes((0, _utils1.parsePrimitiveValue)(metadata[key]));
    },
    [_types.FilterOperator.ANY]: ({ key, value }, metadata)=>{
        return (0, _utils1.parseArrayValue)(value).some((v)=>(0, _utils1.parseArrayValue)(metadata[key]).includes(v));
    },
    [_types.FilterOperator.ALL]: ({ key, value }, metadata)=>{
        return (0, _utils1.parseArrayValue)(value).every((v)=>(0, _utils1.parseArrayValue)(metadata[key]).includes(v));
    },
    [_types.FilterOperator.TEXT_MATCH]: ({ key, value }, metadata)=>{
        return (0, _utils1.parsePrimitiveValue)(metadata[key]).includes((0, _utils1.parsePrimitiveValue)(value));
    },
    [_types.FilterOperator.CONTAINS]: ({ key, value }, metadata)=>{
        return (0, _utils1.parseArrayValue)(metadata[key]).includes((0, _utils1.parsePrimitiveValue)(value));
    },
    [_types.FilterOperator.GT]: ({ key, value }, metadata)=>{
        return (0, _utils1.parseNumberValue)(metadata[key]) > (0, _utils1.parseNumberValue)(value);
    },
...
class SimpleVectorStore extends _types.VectorStoreBase {
    ...
    async add(embeddingResults) {
        for (const node of embeddingResults){
            ...
            const metadata = (0, _utils1.nodeToMetadata)(node, true, undefined, false);
