...
_export(exports, {
    ...
    parseArrayValue: function() {
        return parseArrayValue;
    },
    parseNumberValue: function() {
        return parseNumberValue;
    },
    parsePrimitiveValue: function() {
...
function metadataDictToNode(metadata, options) {
    ...
    switch(nodeType){
        case "IndexNode":
            return (0, _schema.jsonToNode)(nodeObj, _schema.ObjectType.INDEX);
        default:
            return (0, _schema.jsonToNode)(nodeObj, _schema.ObjectType.TEXT);
    }
}
