...
_export(exports, {
    ALL_AVAILABLE_OPENAI_MODELS: function() {
        return ALL_AVAILABLE_OPENAI_MODELS;
    },
    GPT35_MODELS: function() {
        return GPT35_MODELS;
    },
    GPT4_MODELS: function() {
        return GPT4_MODELS;
    },
    OpenAI: function() {
        return OpenAI;
    ...
    isFunctionCallingModel: function() {
        return isFunctionCallingModel;
    }
});
const _env = require("@llamaindex/env");
const _lodash = /*#__PURE__*/ _interop_require_default(require("lodash"));
const _openai = require("openai");
const _llms = require("@llamaindex/core/llms");
const _utils = require("@llamaindex/core/utils");
const _azure = require("./azure.js");
...
class OpenAISession {
    ...
    constructor(options = {}){
        if (options.azure) {
            this.openai = new _openai.AzureOpenAI(options);
        } else {
            if (!options.apiKey) {
            ...
            this.openai = new _openai.OpenAI({
                ...options
            });
        }
    }
...
class OpenAI extends _llms.ToolCallLLM {
    static{
