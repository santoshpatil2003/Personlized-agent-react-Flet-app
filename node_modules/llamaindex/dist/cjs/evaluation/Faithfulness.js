...
class FaithfulnessEvaluator extends _Mixin.PromptMixin {
    serviceContext;
    raiseError;
    evalTemplate;
    refineTemplate;
    constructor(params){
        ...
        this.evalTemplate = params?.faithfulnessSystemPrompt ?? _prompts.defaultFaithfulnessTextQaPrompt;
        this.refineTemplate = params?.faithFulnessRefinePrompt ?? _prompts.defaultFaithfulnessRefinePrompt;
    }
    _getPrompts() {
        return {
