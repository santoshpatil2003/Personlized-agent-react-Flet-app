...
class RelevancyEvaluator extends _Mixin.PromptMixin {
    serviceContext;
    raiseError;
    evalTemplate;
    refineTemplate;
    constructor(params){
        ...
        this.evalTemplate = params?.evalTemplate ?? _prompts.defaultRelevancyEvalPrompt;
        this.refineTemplate = params?.refineTemplate ?? _prompts.defaultRelevancyRefinePrompt;
    }
    _getPrompts() {
        return {
