...
class SentenceSplitter {
    ...
    splitLongSentences;
    constructor(options){
        const { chunkSize = _constants.DEFAULT_CHUNK_SIZE, chunkOverlap = _constants.DEFAULT_CHUNK_OVERLAP, tokenizer = null, paragraphSeparator = defaultParagraphSeparator, chunkingTokenizerFn, splitLongSentences = false } = options ?? {};
        if (chunkOverlap > chunkSize) {
            throw new Error(`Got a larger chunk overlap (${chunkOverlap}) than chunk size (${chunkSize}), should be smaller.`);
        }
        this.chunkSize = chunkSize;
        this.chunkOverlap = chunkOverlap;
        this.tokenizer = tokenizer ?? _env.tokenizers.tokenizer();
