...
export declare function runTransformations(nodesToRun: BaseNode[], transformations: TransformComponent<any>[], transformOptions?: any, { inPlace, cache, docStoreStrategy }?: TransformRunArgs): Promise<BaseNode[]>;
